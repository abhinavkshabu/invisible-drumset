...
## ⬇️ just download and run it (no coding needed)
...
### v1.0.1
- fixed that annoying bug where the exe would just close instantly with no error lol
- now if it crashes you actually get to see WHY (popup + crash_log.txt)
- basically the app was dying during startup and the terminal closed so fast you couldnt even read the error. my bad 💀

### v1.0.0
- first release!! 🎉
- 7 drum pads with hand tracking
- all sounds generated with code (no audio files)
- autoplay beat mode

---

made with mass hysteria by [@abhinavkshabu](https://github.com/abhinavkshabu) 🤙

if you liked this give it a ⭐ it makes me mass hysterical
